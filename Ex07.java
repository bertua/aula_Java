...
public class Ex07 {
    public static void main(String[] args){
        ...
        if(salarioM <= 1412.00){
            ...
            total = 1412.00 * 0.075 + salarioM * 0.09; 
        } else if (salarioM > 2666.68 && salarioM <= 4000.03){
            total = 1412.00 * 0.075 + 2666.68 * 0.09 + salarioM * 0.12;
        } else if (salarioM > 4000.04 && salarioM <= 7786.02){
            total = 1412.00 * 0.075 + 2666.68 * 0.09 + 4000.03 * 0.12 + salarioM * 0.14;
        } else {
            total = 1412.00 * 0.075 + 2666.68 * 0.09 + 4000.03 * 0.12 + 7786.02 * 0.14;
        }
